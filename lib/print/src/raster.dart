...
class PdfRaster {
  ...
  im.Image asImage() {
    ...
    final byteBuffer = Uint8List.fromList(pixels).buffer;
    return im.Image.fromBytes(width: width, height: height, bytes: byteBuffer);
  }
}
...
class PdfRasterImage extends ImageProvider<PdfRaster> {
  ...
  ImageStreamCompleter load(PdfRaster key) {
