...
import 'package:flutter_application_1/pages/users/list/viewmodel/cards_view_model.dart';
...
class _CardsViewState extends State<CardsView> {
  ...
  initaction() async {
    ...
    store.setString('companysearch', _searchController.text);
  }
              ...
              child: new Card(
                child: new ListTile(
                  leading: new IconButton(
                    ...
                    onPressed: () async {
                      final store = await SharedPreferences.getInstance();
                      store.setString('employesearch', _searchController.text);
                      _vm.cards.length = 0;
                      _vm = CardsViewModel();
                      _vm.init();
                      _vm.fetchCards();
