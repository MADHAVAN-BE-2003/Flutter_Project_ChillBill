...
var payment_method = '';
var savcustomername = '';
var savcustomeraddress = '';
var savcustomerphone = '';
var taxRate = '';
var discountRate = '';
var inv_tax_status = '';
var inv_dis_status = '';
...
class _SalesinvoiceState extends State<Salesinvoice> {
  ...
  void initState() {
    ...
    savcustomername = widget.customername;
    savcustomeraddress = widget.customeraddress;
    savcustomerphone = widget.customerphone;

    taxRate = widget.taxRate;
    discountRate = widget.discountRate;
    inv_tax_status = widget.inv_tax_status;
    inv_dis_status = widget.inv_dis_status;
    grandTotal = widget.grandTotal;
    payment_received = widget.payment_received;
    payment_balance = widget.payment_balance;
    payment_words = widget.payment_words;
  ...
  createprint() async {
    ...
    if (itemslistarray.length != 0) {
      ...
      var invoice = Invoicenormal(
        ...
        customer: Customer(
          name: savcustomername,
          address: savcustomeraddress,
        ),
        info: InvoiceInfo(
          date: invoiceDate,
          dueDate: dueDate,
      ...
      if (normalprint == true) {
        ...
        if (normalregularprint == true) {
          ...
          final pdfFile = await generatepdfprint(
              ...
              company_address,
              savcustomername,
              savcustomeraddress + savcustomerphone,
              invoicedata);
        }
      }
              ...
              Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text('payment:' + payment_method,
                          style: TextStyle(fontSize: 15)),
                    ),
                    Container(
                      padding: EdgeInsets.all(10),
                      ...
                      child: Text('discount:' + discountRate + '%',
                          style: TextStyle(fontSize: 15)),
                    ),
                  ]),
              SizedBox(
              ...
              Row(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Text('Received:' + payment_received,
                          style: TextStyle(fontSize: 15)),
                    ),
                    Container(
                      padding: EdgeInsets.all(10),
                      ...
                      child: Text('Balance:' + payment_balance,
                          style: TextStyle(fontSize: 15)),
                    ),
                  ]),
