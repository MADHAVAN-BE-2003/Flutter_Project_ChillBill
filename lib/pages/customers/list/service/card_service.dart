...
import 'package:chill_bill/pages/customers/list/model/card_model.dart';
import 'package:chill_bill/pages/customers/list/service/card_service_interface.dart';
import 'package:chill_bill/pages/customers/list/model/pagination_model.dart';
...
class CardService extends CardServiceInterface {
  ...
  Future<List<CardModel>> fetchCards(PaginationModel paginate) async {
    ...
    var customersearch1 = prefs.getString('customersearch').toString();

    if (customersearch1.length != 0) {
      customersearch = customersearch1;
    }
