...
import 'dart:math';
// import 'package:chill_bill/pages/sales/add_items.dart';
import 'package:shared_preferences/shared_preferences.dart';
// import 'package:chill_bill/createpdf/page/pdf_page.dart';
...
import 'package:chill_bill/pdf/api/pdf_api.dart';
import 'package:chill_bill/pdf/api/pdf_print.dart';
...
import 'package:chill_bill/pages/sales/productgrid.dart';
import 'package:intl/intl.dart';
import 'package:chill_bill/common/api_call.dart';
// import 'package:chill_bill/pages/sales/Productgridk.dart';
// import 'package:chill_bill/pages/sales/Productgridkk.dart';
import 'package:localstorage/localstorage.dart';

// final storage = new LocalStorage('store_product_invoice');

// C:\flutterprojects\invoice_build\chill_bill\lib\pages\sales\Productgridk.dart
...
List<Item> generateItems(int numberOfItems) {
  ...
  return List<Item>.generate(itemslistarray.length, (int index) {
    return Item(
      ...
      headertotal: fruitMap[index]['headertotal'],
  ...
  createprint() async {
    ...
    if (itemslistarray.length != 0) {
      ...
      var invoice = Invoicenormal(
        supplier: Supplier(
          name: billing_name,
          address: widget.company_contact,
          paymentInfo: '',
        ),
        customer: Customer(
          name: customername,
      ...
      if (normalprint == true) {
        ...
        if (normalregularprint == true) {
          ...
          final pdfFile = await generatepdfprint(itemslistarray, billing_name,
          ...
          child: Row(
            children: <Widget>[
              ...
              Column(
                ...
                children: <Widget>[
                  Text(
                    "\₹" + itemslistarray[index]['headertotal'].toString(),
                    style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.w700,
